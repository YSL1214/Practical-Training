...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <table class="layui-table" lay-data="{width: 1302, height:600,url:'/volunteerlistjson/', page:true, id:'oldTable'}" lay-filter="demo">
            <thead>
            <tr>
                <th lay-data="{field:'userName', width:100}">志愿者姓名</th>
                    ...
                    if(obj.event === 'detail'){
                        ...
                        layer.confirm('真的删除行么', function(index){
                            ...
                            layer.open({
                                ...
                                shade: 0.8,  //遮罩透明度
                                area: ['200px', '100px'],
                                content: '/deletevolunteer/'+data.id
                            });
                        });
