...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <table class="layui-table" lay-data="{width: 1302, height:600,url:'/oldlistjson/', page:true, id:'oldTable'}" lay-filter="demo">
            <thead>
            <tr>
                <th lay-data="{field:'userName', width:100}">老人姓名</th>
                <th lay-data="{field:'gender', width:80}">性别</th>
                <th lay-data="{field:'age', width:80}">年龄</th>
                <th lay-data="{field:'phone', width:220}">电话</th>
                <th lay-data="{field:'health_state', width:180, }">健康状况</th>
                    ...
                    if(obj.event === 'detail'){
                        ...
                        layer.confirm('真的删除行么', function(index){
                            ...
                            layer.open({
                                ...
                                shade: 0.8,  //遮罩透明度
                                area: ['200px', '100px'],
                                content: '/deleteoldperson/'+data.id
                            });
                        });
